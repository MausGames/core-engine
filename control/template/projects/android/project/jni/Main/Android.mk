...
V_LIB_PATH := ../../../../../../CoreEngine/libraries
...
LOCAL_SRC_FILES := $(V_SRC_PATH)/main.cpp                                \
                   ...
                   $(V_ENG_PATH)/utilities/data/coreLookup.cpp           \
                   ...
                   $(V_ENG_PATH)/utilities/math/coreMatrix.cpp           \
                   $(V_ENG_PATH)/utilities/math/coreSpline.cpp           \
                   $(V_ENG_PATH)/utilities/math/coreVector.cpp
