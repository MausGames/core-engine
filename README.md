...
The Core Engine is an extensive C++ framework based on the [SDL](https://libsdl.org/) library, currently for **Windows, Linux, macOS and Browser games** and compatible with **OpenGL (ES) 2.x, 3.x and 4.x capable hardware**.
