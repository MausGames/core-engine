/*! \mainpage Main Page
 *
 * <img src="../core_header_cut.png" align="left" alt="Core Engine Logo" style="border-width: 1px; border-color: black; border-style: solid;"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all"><br clear="all">
 *
