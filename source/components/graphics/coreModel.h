...
// TODO 3: share one vertex and index buffer among multiple models (may require staging buffer) (buffer references) (manual definition, which models should share)
