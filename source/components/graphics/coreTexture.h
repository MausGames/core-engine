...
#define CORE_TEXTURE_SPEC_COMPRESSED_BPTC3 (coreTextureSpec(GL_COMPRESSED_RGBA_BPTC_UNORM_ARB, GL_COMPRESSED_RGBA_BPTC_UNORM_ARB, GL_UNSIGNED_BYTE,                3u, 0u))   // ARB_texture_compression_bptc
#define CORE_TEXTURE_SPEC_COMPRESSED_BPTC4 (coreTextureSpec(GL_COMPRESSED_RGBA_BPTC_UNORM_ARB, GL_COMPRESSED_RGBA_BPTC_UNORM_ARB, GL_UNSIGNED_BYTE,                4u, 0u))   // ARB_texture_compression_bptc
