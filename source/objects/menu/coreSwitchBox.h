...
template <typename T> void coreSwitchBox<T>::Move()
{
    ...
    const bool abStatus[2] = {m_apArrow[0]->IsPushed(CORE_INPUT_LEFT, CORE_INPUT_HOLD),
                              m_apArrow[1]->IsPushed(CORE_INPUT_LEFT, CORE_INPUT_HOLD)};
