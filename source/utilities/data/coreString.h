...
public:
    ...
    /* prepend new string */
    constexpr coreString& prepend(const coreChar* pcText)                       {this->insert(0u, pcText ? pcText : "");       return *this;}
    constexpr coreString& prepend(const coreChar* pcText, const coreUintW iNum) {this->insert(0u, pcText ? pcText : "", iNum); return *this;}
