...
public:
    ...
    inline    coreVector2 GetBound90  ()const {return coreVector2(ABS(_11) + ABS(_21),            ABS(_12) + ABS(_22));}
...
public:
    ...
    inline    coreVector3 GetBound90 ()const {return coreVector3(ABS(_11) + ABS(_21) + ABS(_31),      ABS(_12) + ABS(_22) + ABS(_32),      ABS(_13) + ABS(_23) + ABS(_33));}
...
// ****************************************************************
/* additional checks */
STATIC_ASSERT(std::is_trivial_v<coreMatrix3x2>)
STATIC_ASSERT(std::is_trivial_v<coreMatrix4x3>)
STATIC_ASSERT(std::is_trivial_v<coreMatrix2>)
STATIC_ASSERT(std::is_trivial_v<coreMatrix3>)
STATIC_ASSERT(std::is_trivial_v<coreMatrix4>)
