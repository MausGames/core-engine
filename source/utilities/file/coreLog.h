...
public:
    ...
    template <typename... A> inline void ListDeeper      (const coreChar* pcText, A&&... vArgs) {ASSERT(m_iListStatus)                                                            this->__Write(false, __CORE_LOG_PRINT, "<li>",                                              "</li><ul>");   ++m_iListStatus;}
    template <typename... A> inline void ListAdd         (const coreChar* pcText, A&&... vArgs) {ASSERT(m_iListStatus)                                                            this->__Write(false, __CORE_LOG_PRINT, "<li>",                                              "</li>");}
    inline                          void ListEnd         ()                                     {ASSERT(m_iListStatus)                                                            this->__Write(false, __CORE_LOG_CLEAR, "</ul></span>",                                      ""); if(!(--m_iListStatus)) m_Lock.Unlock();}
